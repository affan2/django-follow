...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('follow_follow', (
            ...
            ('target_company', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='follow_company', null=True, to=orm['companies.Company'])),
            ('target_article', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='follow_article', null=True, to=orm['articles.Article'])),
        ))
    ...
    models = {
        ...
        'articles.image': {
            'Meta': {'ordering': "['article', 'order']", 'object_name': 'Image', '_ormbases': ['articles.Resource']},
        ...
        'taggit.taggeditem': {
            ...
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'taggit_taggeditem_tagged_items'", 'to': u"orm['contenttypes.ContentType']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'object_id': ('django.db.models.fields.IntegerField', [], {'db_index': 'True'}),
            'tag': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'taggit_taggeditem_items'", 'to': u"orm['taggit.Tag']"})
        }
    }
