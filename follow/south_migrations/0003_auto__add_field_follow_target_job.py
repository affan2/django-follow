...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Follow.target_job'
        db.add_column('follow_follow', 'target_job',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='follow_job', null=True, to=orm['jobs.Job']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Follow.target_job'
        db.delete_column('follow_follow', 'target_job_id')
    ...
    models = {
        ...
        'articles.article': {
            ...
            'publish_up': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 11, 13, 0, 0)'}),
        ...
        'jobs.job': {
            ...
            'publish_down': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 12, 13, 0, 0)'}),
            'publish_up': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 11, 13, 0, 0)'}),
            'slug': ('django.db.models.fields.SlugField', [], {'unique': 'True', 'max_length': '50'}),
            'state': ('django.db.models.fields.SmallIntegerField', [], {'default': '0'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
