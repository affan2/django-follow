...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('follow_follow', 'site',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('follow_follow', 'site_id')
    ...
    models = {
        ...
        'whitelabel.whitelabel': {
            ...
            'allow_translate': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'whitelabel_whitelabel_created_by'", 'to': u"orm['auth.User']"}),
            ...
            'state': ('django.db.models.fields.SmallIntegerField', [], {'default': '0'}),
            'updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'updated_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'whitelabel_whitelabel_updated_by'", 'null': 'True', 'to': u"orm['auth.User']"}),
